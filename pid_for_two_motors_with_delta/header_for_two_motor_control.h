...
float Kp1 = 0.3, Ki1 = 0.01, Kd1 = 0.0011;  // PID constants
float Kp2 = 0.3, Ki2 = 0.01, Kd2 = 0.0011;  // PID constants

float error1=0.0,prevError1=0.0;
float integral1=0.0, derivative1=0.0;
float setpoint1 = 20.0;  // Desired speeds  

float error2=0.0,prevError2=0.0;
float integral2=0.0, derivative2=0.0;
float setpoint2 = 20.0;  // Desired speeds  
